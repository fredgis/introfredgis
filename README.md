...
.text     0x0F10  →  0x1000             (3856 of 4096 used)
...
`.text` holds 3 856 bytes in a 4 096 block and `.idata` 988 in a 1 024 block.
...
| drop music + scroller + drag + window class | −1008 in `.text`, −520 in `.idata`, **file 5 632 → 4 096** |
