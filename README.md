...
.text     0x0EB0  →  0x1000             (3760 of 4096 used)
...
`.text` holds 3 760 bytes in a 4 096 block and `.idata` 988 in a 1 024 block.
...
| drop music + scroller + drag + window class | −976 in `.text`, −520 in `.idata`, **file 5 632 → 4 096** |
