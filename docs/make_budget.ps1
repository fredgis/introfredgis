...
Budget '5 632' `
    ...
    @(
        ...
        @{n='logo + rain  block font rasteriser';             b=145;  c=$blue},
    ...
    'currency is blocks, not instructions: .text holds 3 760 bytes in its 4 096' `
...
Budget '4 096' `
    ...
    @(
        ...
        @{n='AlphaPass    premultiplied compositor';          b=361; c=$blue},
        ...
        @{n='logo + rain  block font rasteriser';             b=145; c=$teal},
    ...
    '.text holds 2 784 bytes in its 3 072: 288 bytes of headroom left' `
