...
Budget '5 632' `
    ...
    @(
        @{n='WndProc      frame loop and import thunks';      b=1101; c=$teal},
        @{n='DemoMain     window, layered DIB, GDI font';     b=478;  c=$blue},
        @{n='StartMusic   chiptune synthesis and waveOut';    b=432;  c=$pink},
        @{n='starfield    project, trail, respawn';           b=359;  c=$blue},
        @{n='AlphaPass    premultiplied compositor';          b=363;  c=$teal},
        @{n='MakeMask     plank silhouette and smoothstep';   b=312;  c=$pink},
        @{n='BurnEdges    the fire simulation';               b=336;  c=$teal},
        @{n='data         font, palette, tune, scroll text';  b=280;  c=$amber},
        @{n='logo + rain  block font rasteriser';             b=152;  c=$blue},
    ...
    'currency is blocks, not instructions: .text holds 3 856 bytes in its 4 096' `
...
Budget '4 096' `
    ...
    @(
        @{n='DrawFrame    frame loop and import thunks';      b=822; c=$teal},
        @{n='starfield    project, trail, respawn';           b=359; c=$pink},
        @{n='AlphaPass    premultiplied compositor';          b=363; c=$blue},
        @{n='MakeMask     plank silhouette and smoothstep';   b=312; c=$teal},
        @{n='BurnEdges    the fire simulation';               b=336; c=$blue},
        @{n='DemoMain     window, layered DIB, message loop'; b=314; c=$pink},
        @{n='logo + rain  block font rasteriser';             b=152; c=$teal},
    ...
    '.text holds 2 848 bytes in its 3 072: 224 bytes of headroom left' `
