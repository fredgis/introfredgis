...
Budget '5 632' `
    ...
    @(
        @{n='WndProc      frame loop and import thunks';      b=1114; c=$teal},
        @{n='DemoMain     window, layered DIB, GDI font';     b=482;  c=$blue},
        @{n='StartMusic   chiptune synthesis and waveOut';    b=440;  c=$pink},
        @{n='starfield    project, trail, respawn';           b=361;  c=$blue},
        @{n='AlphaPass    premultiplied compositor';          b=366;  c=$teal},
        @{n='MakeMask     plank silhouette and smoothstep';   b=330;  c=$pink},
        @{n='BurnEdges    the fire simulation';               b=339;  c=$teal},
        @{n='data         font, palette, tune, scroll text';  b=280;  c=$amber},
        @{n='logo + rain  block font rasteriser';             b=165;  c=$blue},
    ...
    'currency is blocks, not instructions: .text holds 3 920 bytes in its 4 096' `
...
Budget '4 096' `
    ...
    @(
        @{n='DrawFrame    frame loop and import thunks';      b=845; c=$teal},
        @{n='starfield    project, trail, respawn';           b=361; c=$pink},
        @{n='AlphaPass    premultiplied compositor';          b=366; c=$blue},
        @{n='MakeMask     plank silhouette and smoothstep';   b=330; c=$teal},
        @{n='BurnEdges    the fire simulation';               b=339; c=$blue},
        @{n='DemoMain     window, layered DIB, message loop'; b=316; c=$pink},
        @{n='logo + rain  block font rasteriser';             b=165; c=$teal},
    ...
    '.text holds 2 912 bytes in its 3 072: 160 bytes of headroom left' `
